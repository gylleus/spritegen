...
class CDCGAN(object):
    ...
    def __init__(self, zdim, ydim, xshape, lr=0.00152, beta1=0.5): #too small 0.0015, too large 0.00153
        ...
        # reuse - to use the same discriminator on both the real and fake each iteraion
